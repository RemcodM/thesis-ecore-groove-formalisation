...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="step09">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n0">
        ...
        <node id="n9">
            <attr name="layout">
                <string>106 230 148 34</string>
            </attr>
        </node>
        <node id="n10">
            <attr name="layout">
                <string>274 230 132 34</string>
            </attr>
        </node>
        <node id="n11">
            <attr name="layout">
                <string>37 411 115 34</string>
            </attr>
        </node>
        <node id="n12">
            <attr name="layout">
                <string>405 405 137 34</string>
            </attr>
        </node>
        <node id="n13">
            <attr name="layout">
                <string>424 310 116 34</string>
            </attr>
        </node>
        <node id="n14">
            <attr name="layout">
        ...
        <edge from="n0" to="n14">
            ...
            <attr name="layout">
                <string>476 2 248 616 125 543 11</string>
            </attr>
        </edge>
        <edge from="n1" to="n1">
            <attr name="label">

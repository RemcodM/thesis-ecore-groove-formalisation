...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="step14">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n0">
        ...
        <node id="n9">
            <attr name="layout">
                <string>106 222 148 51</string>
            </attr>
        </node>
        <node id="n10">
            <attr name="layout">
                <string>274 222 132 51</string>
            </attr>
        </node>
        <node id="n11">
            <attr name="layout">
        ...
        <edge from="n0" to="n14">
            ...
            <attr name="layout">
                <string>444 2 248 616 125 543 11</string>
            </attr>
        </edge>
        <edge from="n0" to="n15">
            <attr name="label">

...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="step07">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n0">
            <attr name="layout">
                <string>231 411 85 17</string>
            </attr>
        </node>
        <node id="n1">
            <attr name="layout">
                <string>228 25 75 17</string>
            </attr>
        </node>
        <node id="n4">
            <attr name="layout">
                <string>203 189 145 34</string>
            </attr>
        </node>
        <node id="n5">
            <attr name="layout">
        ...
        <node id="n7">
            <attr name="layout">
                <string>123 138 117 17</string>
            </attr>
        </node>
        <node id="n8">
            <attr name="layout">
                <string>282 139 117 17</string>
            </attr>
        </node>
        <node id="n14">
            <attr name="layout">
                <string>18 297 128 17</string>
            </attr>
        </node>
        <node id="n15">
            <attr name="layout">
                <string>214 296 128 17</string>
            </attr>
        </node>
        <node id="n16">
            <attr name="layout">
                <string>408 297 128 17</string>
            </attr>
        </node>
        <node id="n17">
            <attr name="layout">
                <string>64 412 78 17</string>
            </attr>
        </node>
        <node id="n19">
            <attr name="layout">
                <string>231 105 63 17</string>
            </attr>
        </node>
        <node id="n21">
            <attr name="layout">
                <string>12 126 18 17</string>
            </attr>
        </node>
        <node id="n22">
            <attr name="layout">
                <string>499 137 18 17</string>
            </attr>
        </node>
        <node id="n23">
            <attr name="layout">
                <string>64 376 19 17</string>
            </attr>
        </node>
        <node id="n24">
            <attr name="layout">
                <string>199 352 19 17</string>
            </attr>
        </node>
        <node id="n25">
            <attr name="layout">
                <string>497 364 19 17</string>
            </attr>
        </node>
        <edge from="n0" to="n0">
            <attr name="label">
        ...
        <edge from="n0" to="n14">
            ...
            <attr name="layout">
                <string>615 5 274 420 82 306 11</string>
            </attr>
        </edge>
        <edge from="n0" to="n15">
            <attr name="label">

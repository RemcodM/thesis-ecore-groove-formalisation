\begin{longtable}{|lX|}
\hline
\multicolumn{2}{|l|}{\textbf{Models after step 5}}\\
\hhline{|==|}
\endhead
$Tm_5 = $ & $\mathrm{combine}(Tm_4, Tm_{DataField}) =$ \newline
$\begin{aligned}
...
\end{aligned}$
\\
$Im_5 = $ & $\mathrm{combine}(Tm_4, Im_{DataField}) =$ \newline
$\begin{aligned}
...
\\
\hline
$TG_5 = $ & $\mathrm{combine}(TG_4, TG_{DataField}) =$ \newline
$\begin{aligned}
...
\end{aligned}$
\\
$IG_5 = $ & $\mathrm{combine}(TG_4, IG_{DataField}) =$ \newline
$\begin{aligned}
N =\ & \{TR, BHP, TRRoom1, TRRoom2, BHPRoomA, BHPRoomB, BHPRoomC, \\& \text{``TwoRem''}, \text{``B.H. Paleis''}, \text{``1''},  \text{``2''}, \text{``A''}, \text{``B''}, \text{``C''}\} \\
E =\ & \Big\{
...
\\
\hline
$f_5(Im_5) = $ & $f_4(Im_4) \sqcup f_{DataField}(Im_{DataField})$  (\cref{defin:transformation_framework:instance_models_and_instance_graphs:combining_transformation_functions:combination_transformation_function_instance_model_instance_graph})\\
$f'_5(IG_5) = $ & $f'_4(IG_4) \sqcup f'_{DataField}(IG_{DataField})$  (\cref{defin:transformation_framework:instance_models_and_instance_graphs:combining_transformation_functions:combination_transformation_function_instance_graph_instance_model})\\
\hline
\end{longtable}
\begin{longtable}{|lX|}
\hline
\multicolumn{2}{|l|}{\textbf{Models after step 7}}\\
\hhline{|==|}
\endhead
$Tm_7 = $ & $\mathrm{combine}(Tm_6, Tm_{EnumField}) =$ \newline
$\begin{aligned}
...
\end{aligned}$
\\
$Im_7 = $ & $\mathrm{combine}(Tm_6, Im_{EnumField}) =$ \newline
$\begin{aligned}
...
\\
\hline
$TG_7 = $ & $\mathrm{combine}(TG_6, TG_{EnumFieldFlags}) =$ \newline
$\begin{aligned}
...
\end{aligned}$
\\
$IG_7 = $ & $\mathrm{combine}(TG_6, IG_{EnumFieldFlags}) =$ \newline
$\begin{aligned}
...
\\
\hline
$f_7(Im_7) = $ & $f_6(Im_6) \sqcup f_{EnumFieldFlags}(Im_{EnumField})$  (\cref{defin:transformation_framework:instance_models_and_instance_graphs:combining_transformation_functions:combination_transformation_function_instance_model_instance_graph})\\
$f'_7(IG_7) = $ & $f'_6(IG_6) \sqcup f'_{EnumFieldFlags}(IG_{EnumFieldFlags})$  (\cref{defin:transformation_framework:instance_models_and_instance_graphs:combining_transformation_functions:combination_transformation_function_instance_graph_instance_model})\\
\hline
\end{longtable}